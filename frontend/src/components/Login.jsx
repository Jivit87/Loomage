...
const Login = () => {
    ...
    useEffect(() => {
        document.body.style.overflow = "hidden"; // disables scrolling on the entire page

        return () => { // cleanup function
            document.body.style.overflow = "unset" // restores the original scroll behavior
        }
    }, [])
    ...
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                ...
                <input onChange={e => setPassword(e.target.value)} value={password} type='password' className='outline-none text-sm' placeholder='Passowrd' required/>
            </div>
